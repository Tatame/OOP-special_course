...
public:
    TaskPlus(double first, double second) : BinaryTask{first, second, "+"} {}
...
public:
    TaskMinus(double first, double second) : BinaryTask{first, second, "-"} {}
...
public:
    TaskMultiply(double first, double second) : BinaryTask{first, second, "*"} {}
...
public:
    TaskDivide(double first, double second) : BinaryTask{first, second, "/"} {}
